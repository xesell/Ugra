...
from ugra.presentation.api.ui_routes import router as ui_router
...
async def lifespan(app: FastAPI):
    ...
    from ugra.application.ui.event_store import get_ui_event_store, wire_event_store

    wire_event_store(container.event_bus(), get_ui_event_store())
